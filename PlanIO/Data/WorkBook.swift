...
struct WorkBook {
    static let contents1: [LargeWorkBookChapter] = [
        ...
        LargeWorkBookChapter(chapter: 2, title: "기권과 날씨", midChapters: [
            MidWorkBookChapter(chapter: 1, title: "기권과 지구 기온"), // 교과서 1
            MidWorkBookChapter(chapter: 2, title: "구름과 강수"), // 교과서 2
    ...
    static let contents2: [LargeWorkBookChapter] = [
        LargeWorkBookChapter(chapter: 1, title: "생식과유전", midChapters: [
            // 교과서(1.생식) = 문제지3-2(1.새포 분열, 2.사람의 발생)
            // 각각 소단원 (1,2,3), (4)
            MidWorkBookChapter(chapter: 1, title: "세포 분열"), // 교과서 1
            // 위와 같음
            MidWorkBookChapter(chapter: 2, title: "사람의 발생"), // 교과서 1
        ...
        LargeWorkBookChapter(chapter: 3, title: "별과 우주", midChapters: [
            ...
            // 각각 소단원 (1), (2,3)
            MidWorkBookChapter(chapter: 1, title: "별까지의 거리"), // 교과서 1
            // 위와 같음
